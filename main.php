  ...
  <div class="leftbig">
    <div class="juli"></div>
        <div class="kuan">
            ...
            <div class="left" style="width: 620px;height: 50px;"></div>
    ...
    <div class="juli"></div>
        <div class="kuan">
            <table border="1" width="1000" style="background-color: white;">
              ...
              <tr>
                ...
                <td><a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=usermobile/xiang&id=<?php echo $sid;?>"><?php echo "详情"?></a></td>
             <?php }?>
              </tr>
            </table>
            <p></p>
        ...
        <?php
          if($pageNow>1){
    $prePage = $pageNow-1;
    echo "<a href='http://www.siwutang.vip/swtmanager/main.php?id=$prePage'>上一页</a> ";
    echo "&nbsp;&nbsp;&nbsp;";
  }
  if($pageNow<$pageCount){
    $nextPage = $pageNow+1;
    echo "<a href='http://www.siwutang.vip/swtmanager/main.php?id=$nextPage'>下一页</a> ";
    echo "&nbsp;&nbsp;&nbsp;";
...
<a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=usermobile/test2">text</a>
