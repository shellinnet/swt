  ...
  class SmsDemo
{
   ...
   public static function sendBatchSms($qunfa,$ming,$xue) {
        ...
        $request->setTemplateParamJson(json_encode($xue, JSON_UNESCAPED_UNICODE));
...
// print_r(json_encode($cc,JSON_UNESCAPED_UNICODE));
// echo "<br>";

$arr=array_merge_recursive($c,$b);

print_r(json_encode($qunfa, JSON_UNESCAPED_UNICODE));
echo "<br>";

$response = SmsDemo::sendBatchSms($qunfa,$ming,$arr);
...
var hour=1000*60*60*24;//4小时
setTimeout('myrefresh()',hour); //指定24小时刷新一次
