...
$ssarray=array();
        ...
        //查询课程信息
         $ke="SELECT b.m_name,c.kname,a.* FROM course a,admin b,ke c where time>current_date() and b.id=a.teacherid and c.id=a.kid and c.vip=0 and a.xueyuan<>'' order by time,ktime ";
     ...
     //分页显示
      ...
      $ssarray=fenye($conn,$pre,$pageSize,$pageNow,$rowCount,$pageCount);
      function fenye($conn,$pre,$pageSize,$pageNow,$rowCount,$pageCount){
...
$(document).ready(function(){ 
   $("#button_text1").click(function(){  
                ...
                url='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/kebiao&id=';  
...
<div class=nei>
<div class="juli"></div>
  <div class="kuan ziti"><a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/kebiao">课表信息及补签到</a></div>
  ...
  <div class="inline font">
      ...
      <form action="/swtmanager/backend/web/index.php?r=kecheng/kebiao2" method="post">
                 ...
                 <input type="text" name="tname" placeholder="请输入老师姓名" class="shuru"  >&nbsp;

 
  
            <select name="kname" style="width: 120px;height: 27px;">&nbsp;
              <?php
  ...
  <div class="center">
      ...
      <p></p>
          ...
          <div class="font right">
            <?php
              ...
              if($pageNow>1){
        $prePage = $pageNow-1;
        echo "<a href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/kebiao&id=$prePage'>上一页</a> ";
        echo "&nbsp;&nbsp;&nbsp;";
      }
      ...
      if($pageNow<$pageCount){
        ...
        $nextPage = $pageNow+1;
        echo "<a href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/kebiao&id=$nextPage'>下一页</a> ";
        echo "&nbsp;&nbsp;&nbsp;";
