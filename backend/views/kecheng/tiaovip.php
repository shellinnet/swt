...
<div class="main ziti">
  ...
  <div class="juli"></div>
   ...
   <div class="kuan ziti"><a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/vipkebiao">返回VIP排课,签到修改</a></div>
          <div class="inline">
  ...
  <div class="font">
          ...
          <form action="/swtmanager/backend/web/index.php?r=kecheng/tiaozheng" method="post">
               <div class="left">上课日期：<input  class="shuru" name="text" type="text" readonly = "readonly"  value="<?php echo $time?>" disabled="disabled" /></div>
                ...
                <div class="dangzhong">课程名：<input class="shuru2"  type="text" name="kecheng" readonly = "readonly" value="<?php echo $kkname?>" disabled="disabled"/></div>
