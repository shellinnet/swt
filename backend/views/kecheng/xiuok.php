...
// $files="http://www.siwutang.vip/swtmanager/backend/web/img/".$kk;
$tu="UPDATE ke SET kname='".$course."',lleibie='".$leibie."',img='".$images."' where id='".$id."'";
$tus=mysqli_query($conn,$tu);
echo "<script>alert('课程修改成功!');window.location.href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/main';</script>";
?>
<style>
.container{
    width:1120px;
