...
<div class="main">
  ...
  <div class="kuan">
      ...
      <div class="kuan" >
          ...
          <div style="width: 800px;height: 30px;text-align: right;float:left; display: inline;">
            <?php
              ...
              if($pageNow>1){
        $prePage = $pageNow-1;
        echo "<a href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/vipkebiao2&id=$prePage&ktname=$ktname&lname=$lname'>上一页</a> ";
        echo "&nbsp;&nbsp;&nbsp;";
      }
      ...
      if($pageNow<$pageCount){
        ...
        $nextPage = $pageNow+1;
        echo "<a href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/vipkebiao2&id=$nextPage&ktname=$ktname&lname=$lname'>下一页</a> ";
        echo "&nbsp;&nbsp;&nbsp;";
