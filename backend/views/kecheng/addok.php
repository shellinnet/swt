...
$tu="INSERT INTO ke(kname,leibie,img,tiao) VALUES('".$course."','".$leibie."','".$images."','".$tiao."')";
$tus=mysqli_query($conn,$tu);
echo "<script>alert('课程添加成功!');window.location.href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=kecheng/main';</script>";
?>
