...
$conn=mysqli_connect('hdm121115553.my3w.com','hdm121115553','swt62899308swt','hdm121115553_db');
 ...
 $id=$_REQUEST['id'];
 $cx="DELETE from  admin where id='".$id."'";
    $cha=mysqli_query($conn,$cx);
    var_dump($cha);

 $cx2="DELETE from  auth_assignment where user_id='".$id."'";
    $cha2=mysqli_query($conn,$cx2);
    var_dump($cha2);


// echo "<script> if(confirm( '确定要删除吗？ '))  {location.href='yes.html';}else {location.href='no.html';} </script>"; 
...
<div class="left">&nbsp;</div>
<div class="juli">&nbsp;</div>
<div class="ziti"><a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=admin/main">点击返回！</a></div>
</div>
</div>
