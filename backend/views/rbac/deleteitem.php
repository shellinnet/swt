...
echo "<script> if(confirm( '是否删除？ '))  location.href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=rbac/yes&name=$name';else location.href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=rbac/roles'; </script>";
?> 
