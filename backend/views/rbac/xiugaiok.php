...
echo $teacherid."<br>";
var_dump($students) ;
$del="DELETE from auth_assignment WHERE user_id='".$teacherid."' and type='2'";
$dels=mysqli_query($conn,$del);

$times=time();
if(is_array($students)){
  foreach ($students as $key => $val) { 
  $cx="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$val."','".$times."')";
...
if(is_array($teachers)){
  ...
  $cx2="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valteachers."','".$times."')";
...
if(is_array($teachers2)){
  ...
  $cx3="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valteachers2."','".$times."')";
...
if(is_array($courses)){
  ...
  $cx4="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valcourses."','".$times."')";
...
if(is_array($tongzhis)){
  ...
  $cx5="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valtongzhis."','".$times."')";
...
if(is_array($jiaowus)){
  ...
  $cx6="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valjiaowus."','".$times."')";
...
if(is_array($quanxians)){
  ...
  $cx7="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valquanxians."','".$times."')";
  $cha7=mysqli_query($conn,$cx7);
  var_dump($cha7);   
  }
}

$jiemians=isset($_POST['jiemians'])?$_POST['jiemians']:''; 

if(is_array($jiemians)){
  foreach ($jiemians as $key => $valjiemians) { 
    echo $valjiemians;
  $cx8="INSERT INTO auth_assignment(user_id,item_name,created_at) VALUES('".$teacherid."','".$valjiemians."','".$times."')";
  $cha8=mysqli_query($conn,$cx8);
  var_dump($cha8);   
  }
}
...
<div class="container">
  <div class="juli"></div>
  <div class="ziti">四物堂---特殊权限设置成功</div>
...
<div class="left">&nbsp;</div>
<div class="juli">&nbsp;</div>
<div class="ziti"><a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=rbac/quan">点击返回！</a></div>
</div>
</div>