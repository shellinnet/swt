...
/* @var $model common\models\UsermobileSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="usermobile-model-search">
    ...
    <?php // echo $form->field($model, 'shiduanid') ?>
    ...
    <?php // echo $form->field($model, 'tname') ?>

    <?php // echo $form->field($model, 'adminid') ?>

    <?php // echo $form->field($model, 'adminname') ?>

    <?php // echo $form->field($model, 'lastkeshi') ?>

    <?php // echo $form->field($model, 'riqi') ?>
