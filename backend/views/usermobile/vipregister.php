...
<div class="nei">
  <div class="juli3"></div>
  <div class="kuan ziti"><a href="http://www.siwutang.vip/swtmanager/backend/web/index.php?r=usermobile/vipregister">VIP学员注册</a></div>
    <div class="kuan2">
    <div class="left">&nbsp; </div>
    <div class="left">
      <div class="juli2"></div>
      ...
      <div class="juli"></div>
      <div class="juli" style="padding-left: 15px;"><span style="font-size:14px;color:red;">*</span><span style="font-size:14px;">&nbsp;手机号:&nbsp;&nbsp;</span><input  type="text" name="studentphone" placeholder="请输入手机号" class="shuru"> </div>
      <div class="juli"></div>
      <div class="juli"></div>
      ...
      <div class="juli"></div>
      <div class="juli"></div>
      <div class="juli"><span style="font-size:14px;color:red;">*</span><span style="font-size:14px;">上课课程:&nbsp;</span> <select name="kname" id='address' class="shuru">
             <option >请选择课程</option>
              <?php
