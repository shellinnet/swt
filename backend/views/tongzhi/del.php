...
echo "<script> if(confirm( '是否删除通知？ '))  location.href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=tongzhi/yes&id=$id';else location.href='http://www.siwutang.vip/swtmanager/backend/web/index.php?r=tongzhi/main'; </script>";
