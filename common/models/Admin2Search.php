...
/**
 * Admin2Search represents the model behind the search form about `common\models\Admin`.
 */
class Admin2Search extends Admin
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['m_weixin', 'm_name', 'm_sex', 'm_rzdate', 'm_beizhu', 'username', 'password', 'password_hash', 'avatar', 'auth_key'], 'safe'],
        ];
    }
